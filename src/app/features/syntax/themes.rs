    ...
    (
        ...
        Theme {
            ...
            settings: ThemeSettings {
                ...
                bracket_contents_foreground: Some(SyntectColor {
                    r: 220,
                    g: 220,
                    b: 220,
                    a: 255,
                ...
                brackets_foreground: Some(SyntectColor {
                    r: 220,
                    g: 220,
                    b: 220,
                    a: 255,
                }),
                brackets_background: Some(SyntectColor {
                    r: 20,
                    g: 24,
                    b: 31,
                    a: 255,
                ...
                tags_foreground: Some(SyntectColor {
                    r: 220,
                    g: 220,
                    b: 220,
                    a: 255,
                ...
                find_highlight_foreground: Some(SyntectColor {
                    r: 0,
                    g: 0,
                    b: 0,
                    a: 255,
                ...
                selection_foreground: Some(SyntectColor {
                    r: 0,
                    g: 0,
                    b: 0,
                    a: 255,
                }), // Black (contrasting with blue selection)
                selection_border: Some(SyntectColor {
                    r: 40,
                    g: 60,
                    b: 100,
                    a: 255,
                }), // Darker selection
                inactive_selection: Some(SyntectColor {
                    r: 60,
                    g: 80,
                    b: 120,
                    a: 100,
                }), // Muted selection
                inactive_selection_foreground: Some(SyntectColor {
                    r: 150,
                    g: 150,
                    b: 150,
                    a: 255,
                }), // Muted foreground
                guide: Some(SyntectColor {
                    r: 70,
                    g: 70,
                    b: 70,
                    a: 255,
                }), // Dark gray
                active_guide: Some(SyntectColor {
                    r: 120,
                    g: 120,
                    b: 120,
                    a: 255,
                }), // Lighter gray
                stack_guide: Some(SyntectColor {
                    r: 70,
                    g: 70,
                    b: 70,
                    a: 255,
                }), // Dark gray
                shadow: Some(SyntectColor {
                    r: 0,
                    g: 0,
                    b: 0,
                    a: 100,
        ...
        Theme {
            ...
            settings: ThemeSettings {
                ...
                selection_foreground: Some(SyntectColor {
                    ...
                    b: 255,
                    a: 255,
                }), // White (contrasting with blue selection)
                selection_border: Some(SyntectColor {
                    r: 0,
                    g: 0,
                    b: 150,
